 ...
 * @author msi
 */
public class Loading extends Application implements ChangeListener<Number> {
	...
	Circle particle1, particle2, particle3, particle4, particle5;
	...
	public void buildComponents() throws IOException {
		...
		Group particles = new Group(particle1, particle2, particle3, particle4,
				particle5);
		Group g = new Group(paths, particles, message);
