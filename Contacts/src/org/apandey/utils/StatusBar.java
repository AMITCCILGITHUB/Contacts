...
public class StatusBar {
    ...
    public void initComponents( final Stage parentStage, String message ) {
        ...
        this.scene = new Scene( root, parentStage.getScene().getWidth(), statusBarHeight, Color.web( "#FFFFFF" ) );
        this.scene.getStylesheets().add( Lorens.class.getResource( "/org/map/style/statusbar.css" ).toExternalForm() );
        ...
        StackPane rootStack = new StackPane() {
            ...
            protected void layoutChildren() {
                ...
                stage.setY( parentStage.getY() + parentStage.getScene().getHeight() + statusBarPos );
            }
        };
        ...
        parentStage.yProperty().addListener( new ChangeListener<Object>() {
            ...
            @Override
            public void changed( ObservableValue<?> arg0, Object arg1, Object arg2 ) {
                stage.setY( Double.valueOf( arg2.toString() ) + parentStage.getScene().getHeight() + statusBarPos );
            }
        } );
    }
